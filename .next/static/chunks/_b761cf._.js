(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_b761cf._.js", {
...
"[project]/context/global.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const GlobalContextProvider = ({ children })=>{
    ...
    const connectSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GlobalContextProvider.useCallback[connectSocket]": async ()=>{
            if (!authUser?._id) {
                console.error("No authUser or userId found");
                return;
            }
            console.log("Connecting socket for user:", authUser._id);
            const socketIo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["io"])(BASE_URL, {
                query: {
                    userId: authUser._id
                }
            });
            socketIo.on("connect", {
                "GlobalContextProvider.useCallback[connectSocket]": ()=>{
                    console.log("Socket connected:", socketIo.id);
                }
            }["GlobalContextProvider.useCallback[connectSocket]"]);
            socketIo.on("connect_error", {
                "GlobalContextProvider.useCallback[connectSocket]": (err)=>{
                    console.error("Socket connection error:", err);
                }
            }["GlobalContextProvider.useCallback[connectSocket]"]);
            socketIo.on("getOnlineUsers", {
                "GlobalContextProvider.useCallback[connectSocket]": (usersIds)=>{
    ...
    const checkAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GlobalContextProvider.useCallback[checkAuth]": async ()=>{
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].get("/auth/check");
    ...
    }["GlobalContextProvider.useCallback[checkAuth]"], []);
    const signup = async (data)=>{
        setIsSigningUp(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].post("/auth/signup", data);
            setAuthUser(res.data);
        ...
        // Move redirect inside the promise to ensure `authUser` is set
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Signup failed");
        } finally{
    ...
    const logout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].post("/auth/logout");
            setAuthUser(null);
    ...
    const login = async (data)=>{
        setIsLoggingIn(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].post("/auth/login", data);
            setAuthUser(res.data);
    ...
    const updateProfile = async (data)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].put("/auth/update-profile", data);
            setAuthUser(res.data);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Profile updated succesfully");
        } catch (error) {
...
_s(GlobalContextProvider, "fFDLjq1WiroU0mhguJzitGe+834=");
...
_s(Navbar, "ZAAk+tAA8EOzGK0SJOgir0jqJAQ=", false, function() {
    return [
...
"[project]/context/theme.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
_s(ThemeContextProvider, "+6C7zX0KFXKdtXxqQH7LMHLz9vo=");
...
"[project]/components/ThemeWrapper.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
_s(ThemeWrapper, "LidUGjXGvl6nqLnPI8yC77ot4bM=");
_c = ThemeWrapper;
var _c;
...
"[project]/context/chat.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const ChatContextProvider = ({ children })=>{
    ...
    console.log(socket);
    const getUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatContextProvider.useCallback[getUsers]": async ()=>{
            setIsUsersLoading(true);
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].get("/messages/users");
                setUsers(res.data);
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(error?.response?.data?.message || "Failed to fetch users");
            } finally{
                setIsUsersLoading(false);
            }
        }
    }["ChatContextProvider.useCallback[getUsers]"], []);
    const getMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatContextProvider.useCallback[getMessages]": async (userId)=>{
            setIsMessagesLoading(true);
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].get(`/messages/${userId}`);
    ...
    }["ChatContextProvider.useCallback[getMessages]"], []);
    const sendMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatContextProvider.useCallback[sendMessage]": async (data)=>{
            console.log(selectedUser);
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].post(`/messages/send/${selectedUser._id}`, data);
                setMessages({
                    "ChatContextProvider.useCallback[sendMessage]": (prev)=>[
                            ...prev,
                            res.data
                        ]
                }["ChatContextProvider.useCallback[sendMessage]"]);
            } catch (error) {
    ...
    const subscribeToMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatContextProvider.useCallback[subscribeToMessages]": ()=>{
            if (!socket || !selectedUser) {
                console.error("no socket found");
                return;
            }
            socket?.on("newMessage", {
                "ChatContextProvider.useCallback[subscribeToMessages]": (newMessage)=>{
                    if (newMessage.senderId !== selectedUser._id) console.log("received msg:", newMessage);
                    setMessages({
                        "ChatContextProvider.useCallback[subscribeToMessages]": (prev)=>[
                                ...prev,
                                newMessage
                            ]
                    }["ChatContextProvider.useCallback[subscribeToMessages]"]);
    ...
    const unsubscribeToMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatContextProvider.useCallback[unsubscribeToMessages]": ()=>{
...
_s(ChatContextProvider, "upArbTjZHNugngb1TKBXHjXD/8M=");
_c = ChatContextProvider;
const __TURBOPACK__default__export__ = ChatContextProvider;
var _c;
__turbopack_refresh__.register(_c, "ChatContextProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_b761cf._.js.map